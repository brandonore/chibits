...
const store = createStore({
  ...
  mutations: {
    ...
    SET_UNCLAIMED_REWARDS: (state, payload) => {
        state.unClaimedRewards = payload
    },
  },
  getters: {
    getWeb3: (state) => {
  ...
  actions: {
    ...
    SET_UNCLAIMED_REWARDS({ commit }, payload) {
        commit("SET_UNCLAIMED_REWARDS", payload)
    }
  },
});
